...
class UnifiedEntrypointTests(unittest.TestCase):
    ...
    def test_repository_launcher_is_executable_and_exposes_primary_commands(self) -> None:
        ...
        self.assertIn("validate-ui-design", result.stdout)
        self.assertIn("inspect-ui-design", result.stdout)
        self.assertIn("validate-ui-advisor", result.stdout)
        self.assertIn("collect-ui-advice", result.stdout)
